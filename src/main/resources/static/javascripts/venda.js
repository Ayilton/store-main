Brewer.Venda = (function() {
	...
	function onTabelaItensAtualizada(evento) {
		console.log('valortotalItens',this.tabelaItens.valorTotal());
	...
	function onValoresAlterados() {
		...
		var valorTotal = numeral(this.tabelaItens.valorTotal()) + numeral(this.valorFrete) - numeral(this.valorDesconto);

		//var valorTotal = 20 + numeral(this.valorFrete) - numeral(this.valorDesconto);
